...
export const metadata: Metadata = {
  title: "Safari Destinations | Kenya, Tanzania, Rwanda & Uganda",
  description: "Explore safari destinations across East Africa. Kenya, Tanzania, Rwanda and Uganda — bespoke safaris and gorilla trekking.",
