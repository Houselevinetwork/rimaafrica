...
const CONTACT_FAQS = [
  ...
  { question: "Which countries do you cover?", answer: "We specialise exclusively in East Africa — Kenya, Tanzania, Rwanda and Uganda. That focus means deeper knowledge of fewer places: every camp, guide and route we recommend has been personally vetted by our team." },
