...
const POSTS: Record<string, {
  ...
  "uganda-vs-rwanda-gorilla-trekking": {
    ...
    title: "Uganda or Rwanda for Gorilla Trekking? How to Choose",
    date: "March 2026",
    datePublished: "2026-03-01",
    category: "Uganda · Rwanda",
    body: "Both Uganda's Bwindi Impenetrable Forest and Rwanda's Volcanoes National Park offer world-class trekking to habituated mountain gorilla families. Rwanda is more compact — you can trek and be back at a Kigali hotel by evening. Uganda is wilder and less developed, with lower permit costs and the option to pair gorillas with chimpanzee tracking and tree-climbing lions in the same trip. Neither is the wrong answer. The right choice depends on your budget, your time, and what else is on your itinerary.",
  },
  "kenya-best-seasons": {
