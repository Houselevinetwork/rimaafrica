...
const POSTS = [
  ...
  },
  {
    ...
    excerpt:   "Both countries offer world-class trekking to habituated mountain gorilla families. The permits cost differently, the terrain feels different, and the right choice depends on what else is on your itinerary.",
    image:     `${R2}/gorillaphoto.jpg`,
  },
  {
