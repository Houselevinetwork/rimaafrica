...
export const metadata: Metadata = {
  ...
  description: "Find your style of African travel. Luxury safaris, honeymoons, family adventures, gorilla trekking and conservation travel — all designed for you.",
...
const TYPES = [
  ...
  },
  {
    slug:        "honeymoon",
    label:       "Honeymoon",
    description: "Private tented camps, romantic bush dinners and sundowners under the African sky.",
