...
export const metadata: Metadata = {
  ...
  description:
    "Rima Africa Safaris designs bespoke private journeys across East Africa. Kenya, Tanzania, Rwanda and Uganda safaris and gorilla trekking. Born in Nairobi.",
  keywords: [
    ...
    "Rwanda safari","Uganda wildlife","safari company Kenya","rima africa safaris",
    "safari nairobi","family safari Africa","honeymoon safari","conservation safari",
  ],
  ...
  openGraph: {
    ...
    description: "Bespoke private journeys across Kenya, Tanzania, Rwanda and Uganda. Designed by specialists who have been there.",
    images: [{
      url: "/og-image.jpg",
  ...
  twitter: {
    ...
    title: `${BRAND} | Luxury Bespoke Safari Experiences`,
    description: "Bespoke private journeys across Kenya, Tanzania, Rwanda and Uganda.",
...
const travelAgencySchema = {
  ...
  description: "Rima Africa Safaris designs bespoke private journeys across East Africa — Kenya, Tanzania, Rwanda and Uganda. Born in Nairobi, Kenya.",
  foundingDate: "2020",
  address: {
    "@type": "PostalAddress",
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      { "@type": "OfferCatalog", name: "Kenya Safaris" },
      { "@type": "OfferCatalog", name: "Tanzania Safaris" },
      { "@type": "OfferCatalog", name: "Rwanda Gorilla Trekking" },
      { "@type": "OfferCatalog", name: "Uganda Gorilla & Primate Trekking" },
    ],
  },
  aggregateRating: {
...
const websiteSchema = {
  ...
  url: SITE,
  name: BRAND,
  description: "Luxury bespoke safari experiences across Kenya, Tanzania, Rwanda and Uganda.",
