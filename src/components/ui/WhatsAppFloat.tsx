...
export default function WhatsAppFloat() {
  return (
    <a
      href="https://wa.me/254714728554?text=Hello%20Rima%20Africa%20Safaris%21%20I%20would%20like%20to%20enquire%20about%20a%20bespoke%20safari."
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Chat with Rima Africa Safaris on WhatsApp"
      style={{
        position: "fixed",
        bottom: "1.5rem",
        right: "1.5rem",
      ...
      onMouseEnter={e => {
        ...
        (e.currentTarget as HTMLElement).style.boxShadow = "0 6px 28px rgba(0,0,0,0.5)";
      }}
      onMouseLeave={e => {
    ...
    >
      {/* Pure white WhatsApp icon on jungle green */}
