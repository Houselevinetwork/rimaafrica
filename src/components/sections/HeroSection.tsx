...
// Photo/video crossfade sequence — Kenya, Uganda, Tanzania, Rwanda
const SEQ = [
  { video: `${R2}/kenyavideo.mp4`, photo: `${R2}/kenyaphoto.jpg`,        label: "Kenya" },
  { video: "",                     photo: `${R2}/gorillaphoto.jpg`,     label: "Uganda" },
  { video: "",                     photo: `${R2}/ngorongorocrater.jpg`, label: "Tanzania" },
  { video: "",                     photo: `${R2}/goldenmonkey.jpg`,     label: "Rwanda" },
];

const GROUP_CARDS = DESTINATIONS.map(d => ({
  slug:  d.slug,
  label: d.name,
  image: coverImages[d.slug] || "",
