        ...
        <div className="content-width">
          ...
          <div style={{ maxWidth: "70%", margin: "0 auto", textAlign: "center" }}>
            <p className="font-sans font-light text-white leading-[1.9]"
              ...
              We are a luxury safari company, providing bespoke private journeys across Kenya, Tanzania,
              Rwanda and Uganda that are tailored to each client&apos;s preferences. Our goal is to
